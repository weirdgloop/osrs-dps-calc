...
const Footer: React.FC = () => {
  return (
    <div className={'border-t-8 border-body-500 dark:border-dark-700 py-4 px-4 items-center text-xs bg-btns-300 dark:bg-dark-600 text-body-300 dark:text-gray-300'}>
