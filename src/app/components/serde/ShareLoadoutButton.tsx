...
const ShareLoadoutButton: React.FC = observer(() => {
  ...
  return (
    <>
      <button
        type="button"
        className="transition-all hover:scale-105 hover:text-white border border-body-500 bg-[#3e2816] py-1.5 px-2.5 rounded-md bg-dark-300 border-dark-200 flex items-center gap-1"
        onClick={() => {
          setIsOpen(true);
        }}
      >
