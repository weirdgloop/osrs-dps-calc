  ...
  return (
    <div className="mt-2 text-sm">
      <div className="rounded bg-body-100 dark:bg-dark-500">
        <button
          type="button"
          className={`w-full pt-1 border-b-dark-300 px-2 flex text-gray-300 font-semibold justify-between gap-2 ${isOpen ? 'border-b' : ''}`}
          ...
          <div className="flex gap-8 flex-wrap justify-center">
            <div className="w-72">
              ...
              <MonsterAccordion headerContent="Monster Settings">
                ...
                <MonsterToaInputs />
                <MonsterCoxInputs />
                <MonsterPartySizeInput />
                <MonsterPhaseSelect />
                <MonsterDemonbaneInput />
                <MonsterCurrentHp />
              </MonsterAccordion>
