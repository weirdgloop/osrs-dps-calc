...
export default function Error({
  ...
  return (
    <div className={'w-full h-screen flex items-center justify-center bg-deepgray-500'}>
      <div className={'bg-tile p-10 mx-2 max-w-lg rounded shadow-lg text-center border-t-4 border-orange-400'}>
        <h2 className={'font-serif font-bold text-lg text-orange-400'}>There was an error</h2>
