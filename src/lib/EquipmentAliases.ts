...
const equipmentAliases = {
  ...
  1161: [2613, 2605, 10296, 10298, 10300, 10302, 10304, 22159, 22161, 22163, 22165, 22167, 22169, 22171, 22173, 22175, 22177, 22179, 22181, 22183, 22185, 22187, 22189], // Adamant full helm
  1199: [2611, 2603, 7334, 7340, 7346, 7352, 7358, 22127, 22129, 22131, 22133, 22135, 22137, 22139, 22141, 22143, 22145, 22147, 22149, 22151, 22153, 22155, 22157], // Adamant kiteshield
  1123: [2599, 2607, 23392, 23395, 23398, 23401, 23404], // Adamant platebody
  1073: [2609, 2601], // Adamant platelegs
  1091: [3475, 3474], // Adamant plateskirt
  4708: [4856, 4859, 4858, 4857], // Ahrim's hood#Undamaged
  4714: [4874, 4877, 4876, 4875], // Ahrim's robeskirt#Undamaged
  4712: [4868, 4871, 4870, 4869], // Ahrim's robetop#Undamaged
  4710: [4862, 4865, 4864, 4863], // Ahrim's staff#Undamaged
  ...
  11802: [20368, 29605], // Armadyl godsword
  24192: [24194], // Armadyl halo#Normal
  11826: [26714], // Armadyl helmet
  21898: [24135, 27363, 27365], // Assembler max cape#Normal
  ...
  4718: [4886, 4889, 4888, 4887], // Dharok's greataxe#Undamaged
  4716: [4880, 4883, 4882, 4881], // Dharok's helm#Undamaged
  4720: [4892, 4895, 4894, 4893], // Dharok's platebody#Undamaged
  4722: [4898, 4901, 4900, 4899], // Dharok's platelegs#Undamaged
  21015: [28682], // Dinh's bulwark
  28951: [28953, 28955, 28957, 28902, 28906], // Dizana's max cape#Normal
  ...
  24225: [24227], // Granite maul (ornate handle)#Normal
  21752: [26685, 25193], // Granite ring (i)#Nightmare Zone
  1135: [7370, 7372], // Green d'hide body
  1099: [7378, 7380], // Green d'hide chaps
  4730: [4922, 4925, 4924, 4923], // Guthan's chainskirt#Undamaged
  4724: [4904, 4907, 4906, 4905], // Guthan's helm#Undamaged
  4728: [4916, 4919, 4918, 4917], // Guthan's platebody#Undamaged
  4726: [4910, 4913, 4912, 4911], // Guthan's warspear#Undamaged
  ...
  21793: [21784, 24249, 24234, 29615], // Imbued guthix cape#Normal
  21791: [21776, 24248, 24232, 29617], // Imbued saradomin cape#Normal
  21795: [21780, 24250, 24233, 29614], // Imbued zamorak cape#Normal
  ...
  1153: [12241, 12231, 23785], // Iron full helm
  1191: [12243, 12233], // Iron kiteshield
  1115: [12225, 12235, 23787], // Iron platebody
  1067: [12237, 12227, 23789], // Iron platelegs
  1081: [12239, 12229], // Iron plateskirt
  12810: [12813, 20792, 26156, 26170, 27042], // Ironman helm
  12811: [12814, 20794, 26158, 26160, 26162, 26164, 26172, 26174, 26176, 26178, 27048, 27050, 27052, 27054], // Ironman platebody
  12812: [12815, 20796, 26166, 26180, 27044], // Ironman platelegs
  4732: [4928, 4929, 4930, 4931], // Karil's coif#Undamaged
  4734: [4934, 4935, 4936, 4937], // Karil's crossbow#Undamaged
  4738: [4946, 4947, 4948, 4949], // Karil's leatherskirt#Undamaged
  4736: [4940, 4941, 4942, 4943], // Karil's leathertop#Undamaged
  ...
  4097: [4107, 4117, 20140, 23059, 26539], // Mystic boots
  4095: [4105, 4115, 20134, 23056, 26537], // Mystic gloves
  4089: [4099, 4109, 7400, 20128, 23047, 26531], // Mystic hat
  3054: [21200], // Mystic lava staff
  4093: [4103, 4113, 7398, 20137, 23053, 26535], // Mystic robe bottom
  4091: [4101, 4111, 7399, 20131, 23050, 26533], // Mystic robe top
  ...
  1163: [2619, 2627, 3486, 8464, 8466, 8468, 8470, 8472, 8474, 8476, 8478, 8480, 8482, 8484, 8486, 8488, 8490, 8492, 8494, 10286, 10288, 10290, 10292, 10294, 24034], // Rune full helm
  1201: [2621, 2629, 3488, 7336, 7342, 7348, 7354, 7360, 8714, 8716, 8718, 8720, 8722, 8724, 8726, 8728, 8730, 8732, 8734, 8736, 8738, 8740, 8742, 8744], // Rune kiteshield
  1275: [23276], // Rune pickaxe
  1127: [261, 2623, 3481, 23209, 23212, 23215, 23218, 23221, 24037], // Rune platebody
  1079: [2617, 2625, 3483, 24040], // Rune platelegs
  1093: [3476, 3477, 3485], // Rune plateskirt
  1333: [12389, 23330, 23332, 23334], // Rune scimitar
  ...
  11864: [19639, 19643, 23073, 21264, 19647, 21888, 24370, 25910, 25898, 25904, 29816], // Slayer helmet
  11865: [26675, 19641, 25179, 26676, 19645, 25181, 26680, 23075, 25189, 26678, 21266, 25185, 26677, 19649, 25183, 26674, 25177, 26679, 21890, 25187, 26681, 24444, 25191, 26684, 25912, 25914, 26682, 25900, 25902, 26683, 25906, 25908, 29818, 29820, 29822], // Slayer helmet (i)#Nightmare Zone
  28264: [28475], // Smoke ancient sceptre#Normal
  11787: [12795], // Steam battlestaff
  8846: [24138], // Steel defender#Normal
  1157: [8682, 8684, 8686, 8688, 8690, 8692, 8694, 8696, 8698, 8700, 8702, 8704, 8706, 8708, 8710, 8712, 20178, 20193], // Steel full helm
  ...
  4747: [4958, 4961, 4960, 4959], // Torag's hammers#Undamaged
  4745: [4952, 4955, 4954, 4953], // Torag's helm#Undamaged
  4749: [4964, 4967, 4966, 4965], // Torag's platebody#Undamaged
  4751: [4970, 4973, 4972, 4971], // Torag's platelegs#Undamaged
  ...
  4757: [4988, 4991, 4990, 4989], // Verac's brassard#Undamaged
  4755: [4982, 4985, 4984, 4983], // Verac's flail#Undamaged
  4753: [4976, 4979, 4978, 4977], // Verac's helm#Undamaged
  4759: [4994, 4997, 4996, 4995], // Verac's plateskirt#Undamaged
